...
export function NoonStudioContent() {
  const { t } = useLocale();
    ...
    <main className="px-5 py-20 md:px-8 md:py-28">
      ...
      <section className="px-5 pb-16 md:px-8">
        <div className="mx-auto max-w-3xl">
          <h2 className="font-heading text-2xl font-bold mb-6">{t("case.noon.overviewTitle")}</h2>
      ...
      <section className="px-5 pb-16 md:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="leading-relaxed text-text-secondary mb-4">
            {t("case.noon.challenge1")}
          </p>
          <p className="leading-relaxed text-text-secondary mb-4">
            {t("case.noon.challenge2")}
          </p>
          <p className="leading-relaxed text-text-secondary mb-4">
            {t("case.noon.challenge3")}
          </p>
        </div>
      </section>
      ...
      <section className="px-5 pb-16 md:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="leading-relaxed text-text-secondary mb-4">
            {t("case.noon.approach1")}
          </p>
          <p className="leading-relaxed text-text-secondary mb-4">
            {t("case.noon.approach2")}
          </p>
          <p className="leading-relaxed text-text-secondary mb-4">
            {t("case.noon.approach3")}
          </p>
        </div>
      </section>
      ...
      <section className="px-5 pb-16 md:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <ul className="list-disc space-y-2 pl-6 text-text-secondary mb-6">
            <li>{t("case.noon.result1")}</li>
            <li>{t("case.noon.result2")}</li>
            <li>{t("case.noon.result3")}</li>
            <li>{t("case.noon.result4")}</li>
            <li>{t("case.noon.result5")}</li>
            <li>{t("case.noon.result6")}</li>
            <li>{t("case.noon.result7")}</li>
            <li>{t("case.noon.result8")}</li>
            <li>{t("case.noon.result9")}</li>
            <li>{t("case.noon.result10")}</li>
          </ul>
        </div>
      </section>
